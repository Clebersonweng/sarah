...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { brand_id: @machine.brand_id, consumption: @machine.consumption, hp: @machine.hp, model_id: @machine.model_id, price: @machine.price, year_purchase: @machine.year_purchase } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { brand_id: @machine.brand_id, consumption: @machine.consumption, hp: @machine.hp, model_id: @machine.model_id, price: @machine.price, year_purchase: @machine.year_purchase } }
