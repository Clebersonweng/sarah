...
class FuelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fuel" do
    assert_difference('Fuel.count') do
      post fuels_url, params: { fuel: { description: @fuel.description, name: @fuel.name, price: @fuel.price } }
    end
  ...
  test "should update fuel" do
    patch fuel_url(@fuel), params: { fuel: { description: @fuel.description, name: @fuel.name, price: @fuel.price } }
