...
class CostOperMachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost_oper_machine" do
    assert_difference('CostOperMachine.count') do
      post cost_oper_machines_url, params: { cost_oper_machine: { program_production: @cost_oper_machine.program_production, total: @cost_oper_machine.total } }
    end
  ...
  test "should update cost_oper_machine" do
    patch cost_oper_machine_url(@cost_oper_machine), params: { cost_oper_machine: { program_production: @cost_oper_machine.program_production, total: @cost_oper_machine.total } }
